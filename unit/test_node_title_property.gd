...
func test_sentence_node_main_property():
	...
	assert_bool(main_prop.get_settings_value("visible_in_graph")).is_true()
	assert_bool(main_prop.get_settings_value("is_main_property")).is_true()
	# SentenceNode main property should not be editable
	assert_bool(main_prop.get_settings_value("editable")).is_false()
...
func test_text_node_main_property():
	...
	assert_bool(main_prop.get_settings_value("editable")).is_true()
