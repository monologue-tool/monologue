...
## picture, already resolved: [code]portrait[/code] is a portrait record, [code]curve[/code]
## the four coordinates of an ease, [code]offset[/code] a [Vector2], plus [code]position[/code],
## [code]z_index[/code], [code]flip_h[/code], [code]flip_v[/code] and [code]duration[/code].
