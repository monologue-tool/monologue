...
static func _setup_button(theme: Theme) -> void:
	...
	var hover_pressed_toggle_button_stylebox: StyleBoxFlat = hover_pressed_button_stylebox.duplicate()
...
static func _setup_foldablecontainer(theme: Theme) -> void:
	...
	theme.set_icon("expanded_arrow", "FoldableContainer", preload("res://ui/assets/icons/expanded_arrow.svg"))
	theme.set_icon("expanded_arrow_mirrored", "FoldableContainer", preload("res://ui/assets/icons/expanded_arrow_mirrored.svg"))
	theme.set_icon("folded_arrow", "FoldableContainer", preload("res://ui/assets/icons/folded_arrow.svg"))
	theme.set_icon("folded_arrow_mirrored", "FoldableContainer", preload("res://ui/assets/icons/folded_arrow_mirrored.svg"))
	...
	var title_collapsed_hover_panel_stylebox: StyleBoxFlat = title_collapsed_panel_stylebox.duplicate()
	theme.set_stylebox("title_collapsed_hover_panel", "FoldableContainer", title_collapsed_hover_panel_stylebox)
